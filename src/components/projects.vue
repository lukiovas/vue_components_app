        ...
        <div class="container">
            <div class="float-left">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a href="http://localhost:8081/components/#/projects" class="btn btn-light active">Projects</a>
                    </li>
                 </ul>
  ...
  <pre class="language-json"><code></code></pre>    
       ...
       <table class="table project-table">
           <tbody>
               ...
               <tr>
                   <td>Modules</td>   <td><ul v-if="this.project.modules!==[]" class="list-group"><li class="list-group-item item" v-for="module in this.project.modules" v-bind:key="module.id">{{module.name}}</li></ul></td>
               </tr>
      ...
      this.value.push(tag)
        ...
        createProject(project) {
                    if (this.edit===false) {
                        ...
                        axios.put('http://localhost:8080/api/projects/'+this.project.id,  
                        this.project).then(data => {
                            this.project=this.emptyProject;
                        this.fetchProjects();
                                })
