      ...
      <div class="container">
        <div class="float-left">
          <ul class="nav nav-pills">
            ...
            <li class="nav-item">
              <a
                href="http://localhost:8081/components/#/Modules"
  ...
  <div class="input-group-append">
    ...
    <modal name="create-module" :adaptive="true" height="auto" width="800" :scrollable="true">
      <form
        ...
        action="http://localhost:8081/modules"
        method="post"
      >
        <div class="line">
          ...
          <multiselect
            ...
            tag-placeholder="Add this as new component"
            id="modules"
          ...
          <multiselect
            v-model="module.templates"
            tag-placeholder="Add this as new template"
            id="modules"
            placeholder="Search or add a template"
            label="name"
            :allow-empty="true"
            track-by="id"
    ...
    <modal name="show-module" :adaptive="true" height="800" width="800" :scrollable="true">
      <table class="table module-table">
        <tbody>
          <tr>
            <td>Module Name</td>
            <td>{{this.module.name}}</td>
          </tr>
          <tr>
            <td>Component</td>
            <td v-if="this.module.component!==null">{{this.module.component.name}}</td>
          </tr>
          <tr>
            <td>Templates</td>
            <td>
              <ul class="list-group">
                <li
                  ...
                  v-for="template in this.module.templates"
    ...
    <table class="table">
      ...
      <tbody v-for="module in modules" v-bind:key="module.id">
        <tr class="click">
          ...
          <td @click="editModule(module); showModule();" scope="col">
            <b v-if="module.component!==null">{{module.component.name}}</b>
          </td>
          <td @click="editModule(module); showModule();" scope="col">
            <ul class="list-group">
              <li
                class="list-group-item item"
                v-for="template in module.templates"
                v-bind:key="template.id"
              >
                <b>{{template.name}}</b>
              </li>
          ...
          <td scope="col">
            <button @click="editModule(module); show();" class="btn btn-warning">Edit</button>
          </td>
          <td scope="col">
...
export default {
  ...
  methods: {
    ...
    createModule(module) {
      if (this.edit === false) {
        axios
          .post("http://localhost:8080/api/Modules", this.module)
          .then(data => {
        ...
        axios
          .put(
            "http://localhost:8080/api/Modules/" + this.module.id,
            this.module
          )
          .then(data => {
            this.module = this.emptyModule;
    ...
    generateModule(module) {
      axios
        .post("http://localhost:8080/api/Modules/" + module.id, this.module)
        .then(data => {
          this.fetchModules();
        });
    }
